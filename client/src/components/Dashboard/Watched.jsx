...
import { Trash2, HeartPlus,BookmarkPlus, Eye } from "lucide-react";
...
const Watched = () => {
  ...
  const removeWatched = async (movieId, movieTitle) => {
    try {
      const res = await axios.delete(
        "http://localhost:5000/movie/removeWatched",
        { params: { userId, movieId, movieTitle } }
      );
      if (res.status === 200) {
        toast.success("Removed from Watched ");
        setWatchedMovieId((prev) =>
      ...
      console.error(error);
      toast.error("Error removing from watched!");
    }
  };
        ...
        {auth ? (
          loading ? (
              ...
              >
                {watchedMovie.map((movie, index) => (
                  ...
                  >
                    ...
                    >
                      <Trash2
                        onClick={() => removeWatched(movie.id, movie.title)}
            ...
            <div className="text-center text-gray-400 mt-20 text-lg">
              No movies in your watched yet 🎬 <br />
